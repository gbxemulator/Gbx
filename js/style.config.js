...
const GBX_STYLE_CONFIG = {
    ...
    // Ordre : ligne 1 = Rouge, Bleu, Vert, Jaune, Orange
    //         ligne 2 = Violet, Rose, Blanc, Noir, Bordeaux
    colors: [
        ...
        { id: "bordeaux", name: "Bordeaux", body: "#9d174d", body2: "#831843", shimmer: false, transparent: false },
    ],

...
async function launchGame(game) {
    ...
    window.EJS_ready = async () => {
        ...
        // Charger la save ingame depuis Supabase si elle existe
        if (GBX.user) {
            try {
            ...
            } catch(e) { console.warn('[GBX] Restauration save:', e); }
        }

        // Démarrer l'auto-save après 6s pour ne pas écraser la save restaurée
        setTimeout(() => startAutoSave(), 6_000);
    };

...
function setupPcControls() {
    ...
    // Init : juste l'icône, le panel reste caché (hidden dans le HTML)
    ...
    volPanel?.querySelectorAll('.pc-panel-dot[data-volume]').forEach(dot => {
        dot.addEventListener('click', (e) => {
            ...
            // Appliquer le volume — EmulatorJS setVolume attend 0–100
            try {
                ...
                } else if (typeof gm?.volume !== 'undefined') {
                    gm.volume = val;
                }
            } catch(_) {}
    ...
    function applyScreenSize(size) {
        ...
        // Reset TOTAL — removeAttribute garantit zéro résidu de transform/position

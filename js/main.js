...
function launchGame(game) {
    ...
    // C'est le bon moment pour appeler changeSettingOption
    window.EJS_onGameStart = () => {
        // Colorisation GBC automatique pour les jeux Game Boy Classic (.gb)
        // Donne aux jeux N&B (Pokémon Rouge, Bleu, Jaune...) leurs couleurs GBC
...
function readSaveFile(game) {
    try {
        // Forcer gambatte à flusher la SRAM dans le FS

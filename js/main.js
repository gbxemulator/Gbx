...
async function launchGame(game) {
    ...
    // EJS_onGameStart — core lancé, on injecte la save via syncfs
    window.EJS_onGameStart = async () => {
        // Colorisation GBC pour les jeux GB
        ...
        try {
            ...
            // Écrire dans le FS et forcer une resync IDBFS → WASM
            GBX.emulator.gameManager.FS.writeFile(path, bytes);
            GBX.emulator.gameManager.FS.syncfs(true, () => {
                // Après sync, forcer gambatte à relire la SRAM

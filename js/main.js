...
function updateAuthUI() {
    ...
    if (GBX.user) {
        ...
        // Masquer la rangée non-connecté (Communauté+Contact PC)
        const rowCommunautePC = document.getElementById('btn-row-communaute-pc');
        if (rowCommunautePC) rowCommunautePC.style.display = 'none';
    } else {
        ...
        // Réafficher la rangée non-connecté (Communauté+Contact PC)
        const rowCommunautePC = document.getElementById('btn-row-communaute-pc');
        if (rowCommunautePC) rowCommunautePC.style.display = 'flex';

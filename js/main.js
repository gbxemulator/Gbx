...
async function launchGame(game) {
    ...
    // EJS_onGameStart — core lancé, colorisation + injection save
    window.EJS_onGameStart = async () => {
        ...
        try {
            ...
            GBX.emulator.gameManager.FS.syncfs(false, () => {
            try { GBX.emulator.gameManager.functions.loadSaveFiles(); } catch(_) {}
            });
        } catch(e) {

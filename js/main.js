...
function _attachDrag(el, id) {
    ...
    function onTouchStart(e) {
        ...
        if (!fixedAtStart) {
            ...
            el.style.position        = 'fixed';
            el.style.left            = (r.left / vw * 100) + 'vw';
            el.style.top             = (r.top  / vh * 100) + 'vh';
            el.style.right           = '';
            el.style.bottom          = '';
            el.style.transform       = '';
            el.style.transformOrigin = '';
            _layoutEdit.current[id]  = { x: r.left / vw * 100, y: r.top / vh * 100 };
            fixedAtStart = true;
        }
    ...
    function onTouchMove(e) {
        ...
        let newX  = ((startRect.left + dx) / vw) * 100;
        let newY  = ((startRect.top  + dy) / vh) * 100;
        newX = Math.max(0, Math.min(100 - elW, newX));
        newY = Math.max(0, Math.min(100 - elH, newY));

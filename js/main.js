...
async function _restoreIngameSave(gameId) {
    GBX._pendingSaveArr = null;
    try {
        // Prendre la save la plus récente parmi les 3 slots possibles
        ...
        if (saveRow?.data) {
            ...
            console.info('[GBX] Save Supabase chargee (' + new Date(saveRow.saved_at).toLocaleString('fr-FR') + '), en attente injection FS');
        }

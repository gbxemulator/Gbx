...
function _getStateBase64() {
    try {
        ...
        // EmulatorJS v4 : EmulatorJSGetState() retourne directement
        // un Uint8Array du state courant (en mémoire, pas via FS)
        if (typeof gm.Module?.EmulatorJSGetState !== 'function') {
            console.warn('[GBX] EmulatorJSGetState non disponible');
            return null;
        }

        const data = gm.Module.EmulatorJSGetState();

...
function _attachDrag(el, id) {
    ...
    function onTouchMove(e) {
        ...
        const elW = startRect.width  / vw * 100;
        const elH = startRect.height / vh * 100;
        let newX  = startRect.left + dx;
        let newY  = startRect.top  + dy;
        newX = Math.max(0, Math.min(vw - startRect.width,  newX));
        newY = Math.max(0, Math.min(vh - startRect.height, newY));

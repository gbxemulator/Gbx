...
function setupGameControls() {
    ...
    Object.entries(buttonMap).forEach(([btnId, ejsRealIndex]) => {
        ...
        // Sur mobile, touchstart génère aussi des mousedown/mouseup synthetiques.
        // On bloque les events souris pendant 300ms apres un touch pour eviter le double input.
        ...
        el.addEventListener('touchend', (e) => {
            ...
            setTimeout(() => { _isTouching = false; }, 300);
        }, { passive: false });
        ...
        // Souris (ignore si touch vient d etre declenche)
        el.addEventListener('mousedown',  (e) => { if (_isTouching) return; e.preventDefault(); pressButton(el, ejsRealIndex, true);  });
        el.addEventListener('mouseup',    (e) => { if (_isTouching) return; e.preventDefault(); pressButton(el, ejsRealIndex, false); });
